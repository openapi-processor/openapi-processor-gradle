...
abstract public class OpenApiProcessorTask extends DefaultTask {
    ...
    /**
     * Any other files used by the processor that are considered inputs. Used by gradle for the up-to-date check.
     *
     * @return the input files
     */
    @InputFiles
    abstract public ListProperty<String> getInputFiles();
